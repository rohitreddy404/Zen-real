...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @anime_rtxx</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
